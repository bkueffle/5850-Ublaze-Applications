...
HD_PWD='C:/Users/Benjamin/Documents/Word-documents/CPP/ECE-5850/5850-Ublaze-Applications/src/uBlaze_Applications/uBlaze_Applications.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwr_test_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwr_test_top.tcl -notrace
